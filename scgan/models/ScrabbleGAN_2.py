...
from scgan.models.model_utils import BigGAN_2 as BGAN
...
def create_model(config, char_map, lexicon_path):
    model = ScrabbleGAN_2(config, char_map, lexicon_path)
